...
st.markdown("## Nhận xét:")
st.markdown("- Overall score của các châu lục có khoảng giá trị biến thiên rộng.")
st.markdown("- Hầu hết overall score của các châu lục nằm trong khoang 40 tới 50 điểm. ")
st.markdown("- Nhìn chung Europe và North America tập trung nhiều trường đại học có Overall Score cao hơn các châu lục khác")
...
st.markdown("## Nhận xét:")
st.markdown("- Các điểm dữ liệu phân tán biểu thị Score Overall và Score Industry Income và Score Citations có quan hệ tương quan yếu, ít tác động đến nhau.")
st.markdown("- Score Citations có phân bố các điểm đều từ 0 tới 100.")
st.markdown("- Score Industry Income có các điểm phân bố từ 45 tới 100.")
